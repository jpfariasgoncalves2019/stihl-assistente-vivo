-- População das tabelas staging com dados reais dos CSVs
-- Esta migration importa dados sample para teste do sistema

-- Limpar tabelas staging primeiro
TRUNCATE TABLE stg_pecas, stg_motossera, stg_produtos_a_bateria, stg_outras_maquinas, 
               stg_ro_adeiras_e_implementos, stg_sabres_correntes_pinhoes_limas,
               stg_conjunto_de_corte_ro_adeiras, stg_cod_alterados, stg_calculadora;
