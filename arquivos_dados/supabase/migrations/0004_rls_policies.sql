...
-- Public read to part/model aliases may help auto-complete (optional). Keep closed by default.
-- Uncomment to allow anonymous reads:
-- create policy "aliases_read" on part_aliases for select to anon, authenticated using (true);
-- create policy "model_aliases_read" on model_aliases for select to anon, authenticated using (true);